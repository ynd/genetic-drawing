...
public class SingleMutationOperator
    ...
    public void operate(final Population a_population,
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (decision) {
                int color = generator.nextInt(GAInitialChromosomeFactory.getNumberOfColorGenesPerPolygon());
                target = color + polygon * GAInitialChromosomeFactory.getNumberOfGenesPerPolygon();
            } else {
                int point = generator.nextInt(GAInitialChromosomeFactory.getNumberOfGenesPerPoint() *
